...
class AppTheme {
  ...
  static MaterialTheme _baseTheme(BuildContext context) =>
      MaterialTheme(createTextTheme(context, "Inter", "Poppins"));

  static ThemeData themeData(BuildContext context) =>
      _baseTheme(context).light().copyWith(
            inputDecorationTheme: _inputDecorationTheme,
            elevatedButtonTheme: _elevatedButtonTheme,
          );

  static ThemeData themeDataDark(BuildContext context) =>
      _baseTheme(context).dark().copyWith(
            inputDecorationTheme: _inputDecorationTheme,
            elevatedButtonTheme: _elevatedButtonTheme,
          );
}
...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffa2f2d8),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff116b57),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff277a65),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff116b57),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff005443),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xffa2f2d8),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xff9cecd2),
      surfaceTint: Color(0xff87d6bd),
      onPrimary: Color(0xff002c22),
      primaryContainer: Color(0xff509f88),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xffc7e2d7),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffb4ffe6),
      surfaceTint: Color(0xff87d6bd),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xff83d2b9),
